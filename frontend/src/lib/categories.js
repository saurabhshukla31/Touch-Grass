...
export const CATEGORIES = [
  {
    ...
    accent: "#22c55e",
    accentSoft:
      "radial-gradient(ellipse at 60% 30%, #052e1688 0%, #0a0a0a 70%)",
    iconKey: "grass",
    hero: true,
    glow: "#16a34a",
    svg: (
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <path
          d="M18 40 C16 32 10 28 12 18 C14 24 18 28 20 34"
          fill="#16a34a"
          opacity="0.7"
        />
        <path
          d="M30 40 C32 32 38 28 36 18 C34 24 30 28 28 34"
          fill="#16a34a"
          opacity="0.7"
        />
        <path
          d="M24 40 C24 30 14 22 16 10 C20 18 24 22 24 22 C24 22 28 18 32 10 C34 22 24 30 24 40Z"
          fill="#22c55e"
        />
        <path
          d="M24 22 C24 22 21 17 22 12 C23 16 24 22 24 22Z"
          fill="#4ade80"
          opacity="0.6"
        />
  ...
  },
  {
    ...
    accent: "#f97316",
    accentSoft:
      "radial-gradient(ellipse at 60% 30%, #2c120788 0%, #0a0a0a 70%)",
    iconKey: "coffee",
    glow: "#ea580c",
    svg: (
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M16 10 C16 8 18 7 18 5"
          stroke="#fb923c"
          strokeWidth="1.5"
          strokeLinecap="round"
          opacity="0.5"
  ...
  },
  {
    ...
    accent: "#eab308",
    accentSoft:
      "radial-gradient(ellipse at 60% 30%, #1c150088 0%, #0a0a0a 70%)",
    iconKey: "fuel",
    glow: "#ca8a04",
    svg: (
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <path
          d="M30 18 C36 18 38 14 38 14 L40 14 L40 22 C40 26 38 28 36 28 L30 28"
          stroke="#eab308"
          strokeWidth="2.5"
          strokeLinecap="round"
          fill="none"
  ...
  },
  {
    ...
    accent: "#ef4444",
    accentSoft:
      "radial-gradient(ellipse at 60% 30%, #2d0a0a88 0%, #0a0a0a 70%)",
    iconKey: "hospital",
    glow: "#dc2626",
    svg: (
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    accent: "#fb923c",
    accentSoft:
      "radial-gradient(ellipse at 60% 30%, #2c100588 0%, #0a0a0a 70%)",
    iconKey: "utensils",
    glow: "#f97316",
    svg: (
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
          d="M18 30 C18 26 22 24 24 24 C26 24 30 26 30 30"
          fill="#ea580c"
          opacity="0.7"
        />
        <line
  ...
  },
  {
    ...
    accent: "#10b981",
    accentSoft:
      "radial-gradient(ellipse at 60% 30%, #02291888 0%, #0a0a0a 70%)",
    iconKey: "pill",
    glow: "#059669",
    svg: (
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M12 32 C12 38 36 38 36 32 L33 24 H15 Z"
          fill="#064e3b"
          opacity="0.7"
        />
        <path
  ...
  },
  {
    ...
    accent: "#3b82f6",
    accentSoft:
      "radial-gradient(ellipse at 60% 30%, #0a162888 0%, #0a0a0a 70%)",
    iconKey: "landmark",
    glow: "#2563eb",
    svg: (
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    accent: "#a855f7",
    accentSoft:
      "radial-gradient(ellipse at 60% 30%, #1a0a2e88 0%, #0a0a0a 70%)",
    iconKey: "dumbbell",
    glow: "#9333ea",
    svg: (
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    accent: "#94a3b8",
    accentSoft:
      "radial-gradient(ellipse at 60% 30%, #0f172a88 0%, #0a0a0a 70%)",
    iconKey: "shuffle",
    glow: "#64748b",
    svg: (
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
